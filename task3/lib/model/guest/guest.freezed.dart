...
mixin _$Guest {
  ...
  dynamic get plusOne => throw _privateConstructorUsedError;
...
abstract class $GuestCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic name, dynamic plusOne});
}
...
class __$$_GuestCopyWithImpl<$Res> extends _$GuestCopyWithImpl<$Res, _$_Guest>
  ...
  $Res call({
    ...
    return _then(_$_Guest(
      ...
      plusOne: null == plusOne ? _value.plusOne : plusOne,
    ));
  }
}
...
class _$_Guest implements _Guest {
  const _$_Guest({required this.name, required this.plusOne});
  ...
  final dynamic name;
  @override
  final dynamic plusOne;

  @override
  String toString() {
    return 'Guest(name: $name, plusOne: $plusOne)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.plusOne, plusOne));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(plusOne));
...
abstract class _Guest implements Guest {
  const factory _Guest(
      {required final dynamic name, required final dynamic plusOne}) = _$_Guest;
